            ...
            <button v-else @click="$emit('update:modelValue', tab.id)"
                ...
                :class="[
                    modelValue === tab.id 
                        ...
                        : (tab.danger ? 'bg-secondary-main hover:bg-danger-bg hover:text-danger-text border-border-default/50' : 'bg-secondary-main text-secondary-text hover:bg-secondary-hover hover:text-text-h border-secondary-border/50')
                ]"
            >
