...
<template>
    <button 
        :type="type"
        :disabled="disabled"
        class="inline-flex items-center justify-center px-4 py-2 text-base rounded-[var(--radius-md)] transition-all duration-fast outline-none active:scale-95 border disabled:shadow-none disabled:cursor-not-allowed disabled:active:scale-100"
        :class="{
            /* PRIMARY */
