                        ...
                        <div class="max-w-md space-y-4">
                            ...
                            <div class="pt-3 border-t border-border-default/60 flex flex-col gap-2.5">
                                ...
                                <div v-if="updateCheckFeedback" :class="[
                                    ...
                                    <span class="text-xs leading-normal">{{ updateCheckFeedback.message }}</span>
                                </div>
                            </div>
                        </div>
                    </BaseCard>
