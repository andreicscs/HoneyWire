                ...
                <form @submit.prevent="doSetup" class="space-y-6 mt-2">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="space-y-1.5">
                                ...
                                <input type="password" v-model="password" placeholder="Password"
                                    class="w-full px-3 py-2 rounded-md bg-bg-inset border border-border-default text-sm mono text-text-main focus:outline-none focus:ring-1 focus:border-highlight-border focus:ring-highlight-ring transition-all placeholder:text-text-muted/50 shadow-inner" required>
                            </div>
                            <div class="space-y-1.5">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="flex gap-2">
                                <input type="text" v-model="hubKey" placeholder="Secure API Key"
                                    class="flex-1 px-3 py-2 rounded-md bg-bg-inset border border-border-default text-sm mono text-text-main focus:outline-none focus:ring-1 focus:border-highlight-border focus:ring-highlight-ring transition-all placeholder:text-text-muted/50 shadow-inner" required>
                                <button type="button" @click="generateKey" 
                                        class="px-4 py-2 rounded-md bg-bg-surface border border-border-default text-text-main text-[10px] font-bold uppercase tracking-wider hover:bg-button-hover transition-colors shadow-sm">
                                    Generate
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="pt-4">
                        <button type="submit" :disabled="loading"
                                ...
                                :class="loading ? 'bg-bg-inset text-text-muted border-border-default cursor-not-allowed' : 'bg-text-main text-bg-surface hover:opacity-90 border-text-main'">
