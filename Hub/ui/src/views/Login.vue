                ...
                <form @submit.prevent="doLogin" class="space-y-6 mt-2">
                    <div class="space-y-2">
                        ...
                        <input type="password" id="pwd" v-model="password" placeholder="••••••••••••"
                            class="w-full px-4 py-2.5 rounded-md bg-input-bg border border-input-border text-sm mono text-text-main focus:outline-none focus:ring-1 focus:border-highlight-border focus:ring-focus-ring transition-all placeholder:text-text-muted/50 shadow-inner" required>
                    </div>
                    
                    <button type="submit" :disabled="loading || rateLimited"
                            class="w-full py-2.5 rounded-md text-sm font-bold transition-all duration-200 active:scale-95 outline-none focus:ring-2 focus:ring-focus-ring border shadow-sm"
                            :class="(loading || rateLimited) ? 'bg-disabled-bg text-disabled-text border-disabled-border cursor-not-allowed shadow-none active:scale-100' : 'bg-primary-main text-primary-text border-primary-main hover:bg-primary-hover hover:shadow-md'">
