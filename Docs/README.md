...
### [2. Architecture (`/architecture`)](./architecture/README.md)
...
### [3. Development (`/development`)](./development/README.md)
...
**Tip:** If you're just getting started and want to deploy your first sensor, start by reading the **[Operations Guide](./operations.md)**!
